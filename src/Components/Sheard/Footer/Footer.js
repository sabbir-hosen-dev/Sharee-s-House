...
function Footer() {
  return (
    <div className=" bg-slate-100">
      <footer class="footer container m-auto px-5 text-neutral py-10">
        ...
        <nav>
          ...
          <div class="grid grid-flow-col gap-4">
            <div className="medi flex gap-2 mt-2">
              <a href="https://www.facebook.com/profile.php?id=61566035229823&mibextid=ZbWKwL" target="_blank" rel="noreferrer">
              ...
              <a href="https://m.me/61566035229823" target="_blank" rel="noreferrer">
